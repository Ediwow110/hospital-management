const ROLE_PERMISSIONS = Object.freeze({
  ...
  manager: ['report.view', 'report.export', 'approval.review', 'billing.refund.approve', 'order.void.approve'],
  department_manager: ['report.view', 'approval.review'],
  receptionist: ['patient.view', 'patient.create', 'patient.update', 'order.create', 'queue.manage'],
  cashier: ['billing.payment.create', 'billing.refund.request', 'billing.payment.void.request', 'cashier.close', 'report.view'],
